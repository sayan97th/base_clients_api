...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Extended time to live (Keep me logged in)
    |--------------------------------------------------------------------------
    |
    | TTL in minutes issued when the user checks "Keep me logged in".
    | Defaults to 43200 minutes (30 days).
    |
    */

    'long_ttl' => (int) env('JWT_LONG_TTL', 43200),
