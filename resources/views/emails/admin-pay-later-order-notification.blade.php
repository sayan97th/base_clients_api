...
<head>
    ...
    <title>New Pay Later Order — {{ $invoice_number }} — {{ config('app.name') }}</title>
</head>
        ...
        <tr>
            ...
            <td width="600"
                ...
                <div style="box-sizing:border-box;max-width:600px;margin:0 auto;display:block;padding:24px;">
                    ...
                    {{-- Main card --}}
                    <table width="100%" cellpadding="0" cellspacing="0" border="0"
                        style="margin:0;box-sizing:border-box;background-color:#ffffff;border-top-width:4px;border-top-style:solid;border-top-color:#f59e0b;border-radius:6px;overflow:hidden;">
                        <tr>
                            <td style="margin:0;box-sizing:border-box;vertical-align:top;padding:0 40px 36px;">

                                {{-- Badge --}}
                                <div style="text-align:center;padding:28px 0 16px;">
                                    <span style="display:inline-block;background-color:#fef3c7;color:#d97706;font-size:11px;font-weight:700;letter-spacing:1.5px;padding:5px 16px;border-radius:20px;">
                                        NEW PAY LATER ORDER
                                    </span>
                                </div>
                                ...
                                <h1 align="center"
                                    ...
                                    A client placed a Pay Later order
                                </h1>

                                <p align="center"
                                    style="margin:0 0 28px;font-weight:normal;color:#6b7280;font-size:13px;">
                                    Invoice #{{ $invoice_number }} · Payment pending
                                </p>
                                ...
                                <p style="margin:0 0 24px;font-weight:normal;color:#374151;font-size:15px;line-height:1.6;">
                                    A client has placed an order using the <strong style="color:#d97706;">Pay Later</strong> option. An invoice has been generated and is awaiting payment. Work will begin once payment is received.
                                </p>

                                {{-- Alert box --}}
                                <div style="box-sizing:border-box;background-color:#fffbeb;border:1px solid #fde68a;border-radius:6px;padding:14px 18px;margin:0 0 24px;">
                                    <p style="margin:0;font-size:13px;color:#92400e;line-height:1.6;">
                                        <strong>Action required:</strong> Review this order in the admin panel. The client will pay when convenient — work should only begin after payment is confirmed.
                                    </p>
                                </div>
                                ...
                                <table cellpadding="0" cellspacing="0" border="0" width="100%"
                                    ...
                                    <tr>
                                        <td style="padding:14px 20px;border-bottom:1px solid #f3f4f6;">
                                            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                <tr>
                                                    <td style="font-size:12px;color:#6b7280;font-weight:600;text-transform:uppercase;letter-spacing:0.5px;width:130px;">Amount Due</td>
                                                    <td style="font-size:15px;color:#d97706;font-weight:700;">{{ $total_amount }}</td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="padding:14px 20px;border-bottom:1px solid #f3f4f6;">
                                            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                <tr>
                                                    <td style="font-size:12px;color:#6b7280;font-weight:600;text-transform:uppercase;letter-spacing:0.5px;width:130px;">Status</td>
                                                    <td style="font-size:14px;">
                                                        <span style="display:inline-block;background-color:#fef3c7;color:#d97706;font-size:11px;font-weight:700;letter-spacing:0.5px;padding:2px 10px;border-radius:12px;">
                                                            PAYMENT PENDING
                                                        </span>
                                                    </td>
                                                </tr>
                                    ...
                                    <tr>
                                        <td style="padding:14px 20px;border-bottom:1px solid #f3f4f6;">
                                            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                <tr>
                                                    <td style="font-size:12px;color:#6b7280;font-weight:600;text-transform:uppercase;letter-spacing:0.5px;width:130px;">Order Date</td>
                                                    <td style="font-size:13px;color:#374151;">{{ $order_date }}</td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td style="padding:14px 20px;">
                                            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                <tr>
                                                    <td style="font-size:12px;color:#6b7280;font-weight:600;text-transform:uppercase;letter-spacing:0.5px;width:130px;">Payment Due</td>
                                                    <td style="font-size:13px;color:#374151;">{{ $date_due }}</td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
                                ...
                                <div style="box-sizing:border-box;text-align:center;margin:0 0 24px;">
                                    <a href="{{ $view_invoice_url }}"
                                        style="text-decoration:none;color:#ffffff;background-color:#d97706;padding:12px 48px;line-height:28px;font-weight:600;font-size:15px;text-align:center;display:inline-block;border-radius:6px;"
                                        target="_blank">
                                        View Invoice &amp; Order
                                    </a>
                                </div>
                                ...
                                <p style="margin:0 0 8px;font-weight:normal;font-size:12px;color:#9ca3af;text-align:center;line-height:1.6;">
                                    You received this notification because you are on the order alert list.
