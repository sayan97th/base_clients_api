                                    ...
                                    <tr>
                                        <td style="margin:0;box-sizing:border-box;vertical-align:top;padding:0;">
                                            ...
                                            <p align="center"
                                                ...
                                                @elseif ($notification_type === 'post')
                                                    There is new content available for you
                                                @else
                                                    Important update from {{ $app_name }}
                                                @endif
                                            </p>
                                            ...
                                            @if ($preview_text)
                                                {{-- Preview Text Block --}}
                                                <div
                                                    style="box-sizing:border-box;padding:15px 20px;color:#343a40;margin:15px 0;background-color:#f8f9fa;border-radius:4px;border-left:3px solid #ec3c89;">
                                                    <p style="margin:0;font-weight:normal;font-size:13px;color:#495057;">
                                                        {{ $preview_text }}
                                                    </p>
                                                </div>
                                            @endif
