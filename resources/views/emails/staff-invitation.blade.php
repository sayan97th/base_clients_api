...
<head>
    ...
    <title>Admin Invitation — {{ config('app.name') }}</title>
</head>
                        ...
                        <tr>
                            <td style="margin:0;box-sizing:border-box;vertical-align:top;padding:0 40px 36px;">
                                ...
                                <p align="center"
                                    ...
                                    You have been granted <strong style="color:#374151;">{{ $role_label }}</strong> access to the admin panel
                                </p>
                                ...
                                <p style="margin:0 0 20px;font-weight:normal;color:#374151;font-size:15px;line-height:1.6;">
                                    ...
                                    <strong>{{ $app_name }}</strong> platform as a
                                    <strong>{{ $role_label }}</strong>. Click the button below to create
                                    your account and get started right away.
                                </p>

                                {{-- Role highlight block --}}
                                <div style="box-sizing:border-box;padding:16px 20px;color:#1f2937;margin:0 0 24px;background-color:{{ $brand_bg }};border-radius:6px;border-left:4px solid {{ $brand_color }};">
                                    ...
                                    <p style="margin:0 0 6px;font-weight:600;font-size:15px;color:#111827;">
                                        {{ $role_label }}
                                    </p>
                                    <p style="margin:0;font-size:13px;color:#6b7280;line-height:1.5;">
                                        You will have access to the {{ $app_name }} admin panel with the privileges assigned to this role.
                                    </p>
                                </div>
                                ...
                                {{-- URL fallback --}}
                                <p style="margin:16px 0 0;font-weight:normal;font-size:12px;color:#9ca3af;text-align:center;line-height:1.6;">
                                    Or copy and paste this link into your browser:<br>
                                    <a href="{{ $accept_url }}"
                                        style="color:{{ $brand_color }};text-decoration:none;word-break:break-all;font-size:11px;">
                                        {{ $accept_url }}
                                    </a>
                                </p>
