...
<head>
    ...
    <title>New reply to your support ticket — {{ config('app.name') }}</title>
</head>
                        ...
                        <tr>
                            <td style="margin:0;box-sizing:border-box;vertical-align:top;padding:0 40px 36px;">
                                ...
                                <h1 align="center"
                                    ...
                                    The {{ $app_name }} team replied to your ticket
                                </h1>
                                ...
                                <p style="margin:0 0 24px;font-weight:normal;color:#374151;font-size:15px;line-height:1.6;">
                                    <strong>{{ $admin_name }}</strong> from the {{ $app_name }} support team has responded to your ticket. Here's what they said:
                                </p>
                                ...
                                <p style="margin:0;font-weight:normal;font-size:12px;color:#9ca3af;text-align:center;line-height:1.6;">
                                    You received this email because you submitted a support ticket with {{ $app_name }}.
                                </p>
